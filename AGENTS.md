...
OG-USA is a United States country calibration of the OG-Core overlapping-generations model of demographics and fiscal policy.
...
- Full example run (slow, ~35 min – 2 hr): `uv run python examples/run_og_usa.py`.
